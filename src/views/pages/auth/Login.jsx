...
import { successNotify, errorNotify } from "@/services/Notifications";
  ...
  const handleLogin = (e) => {
    ...
    userLogin(values.email, values.password)
      .then((res) => {
        console.log(res);
        if (res.success) {
          successNotify("Horray!", "It's a pleasure to have you back.");
          setTimeout(() => {
            window.location = "/";
          }, 5000);
        }
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen bg-gray-50">
      <div className="flex flex-col items-center py-8 mb-3 w-80 bg-white rounded-2xl border border-gray-300 shadow-2xl">
        <form className="flex flex-col mt-8 w-64" onSubmit={handleLogin}>
          <div className="mb-5">
            <img
              className="w-28"
          ...
          <h1 className="self-start mb-7 text-2xl font-semibold">Login</h1>
        ...
        <a href="/forget" className="mt-4 -mb-4 text-blue-900 cursor-pointer">
          Forgot password?
        </a>
      </div>
      <div className="py-4 w-80 text-center bg-white rounded-2xl border border-gray-300 shadow-xl">
